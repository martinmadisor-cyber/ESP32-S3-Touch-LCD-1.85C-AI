...
#define LV_USE_DRAW_SW 1
#if LV_USE_DRAW_SW == 1
    /* guarantee a static simple layer buffer in PIXELS (width * lines) */
    #define LV_DRAW_SW_LAYER_SIMPLE_BUF_SIZE         (LV_HOR_RES_MAX * 8)
    #define LV_DRAW_SW_LAYER_SIMPLE_FALLBACK_BUF_SIZE (LV_HOR_RES_MAX * 8)
    ...
    #define LV_DRAW_SW_COMPLEX          1 // 0: simple, 1: complex FOR TESTING set to
